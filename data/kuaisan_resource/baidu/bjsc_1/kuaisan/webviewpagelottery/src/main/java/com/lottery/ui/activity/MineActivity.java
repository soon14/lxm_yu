...
//    SwitchButton switchButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initView();
        initToolbar("我的",this,true);
    }

    private void initView() {
        findViewById(R.id.setting_computation).setOnClickListener(mOnClickListener);
        findViewById(R.id.setting_feedback_ll).setOnClickListener(mOnClickListener);
        findViewById(R.id.setting_version_update_ll).setOnClickListener(mOnClickListener);
        findViewById(R.id.setting_help).setOnClickListener(mOnClickListener);

        switchButton = (SwitchButton) findViewById(R.id.setting_switchButton);
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (i == R.id.setting_feedback_ll) {
                intent = new Intent(getContext(), UserFeedbackActivity.class);
                startActivity(intent);

            } else if (i == R.id.setting_version_update_ll) {
