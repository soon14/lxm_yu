...
//        mContactsIntent = new Intent(this, KnowledgeActivity.class);
        ...
        mContactsIntent = new Intent(this, KnowledgeNextActivity.class);
        mContactsIntent.putExtra("Knowledge_url", "http://m.500.com/info/zhishi/zt.shtml");
        mContactsIntent.putExtra("Knowledge_title", "详情");



        mCircleIntent = new Intent(this, ExplainActivity.class);
        mCircleIntent.putExtra("url", "http://www.sporttery.cn/wap/help/");
...
//                getResources().getDrawable(R.drawable.selector_zoushi_bg), "走势");
        ...
        chatTabItem = new MenuTabItem(mContext, null, mContactsIntent,
                getResources().getDrawable(R.drawable.selector_main_rb2),"精彩专题");

        circleTabItem = new MenuTabItem(mContext, null, mCircleIntent,
                getResources().getDrawable(R.drawable.select_knowledge_rb), "帮助中心");
