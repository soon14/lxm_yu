...
//    public static final String DITITAL = "^[0-9.]+$";  //
    ...
    public static List<String> matchStrList(String matcher, String str) {
        ...
        Matcher m = p.matcher(str);
        while (m.find()){
            Log.i("lxm","lxm matchStrList:" +m.group(0));
            stringList.add(m.group(0));
        }
        return  stringList ;
    }
    public static String matchStrStr(String matcher, String str) {

        StringBuilder stringBuilder = new StringBuilder("");
        Pattern p = Pattern.compile(matcher);
        Matcher m = p.matcher(str);
        while (m.find()){
            Log.i("lxm","lxm matchStrList:" +m.group(0) + "  " + m.group(1));
    ...
    public static String matchRepalce(String matcher, String str,String replaceStr) {
        Pattern p = Pattern.compile(matcher);
        Matcher m = p.matcher(str);
        if (m.find()) {
