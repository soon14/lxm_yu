package com.lxm.ss.shishicai.widget;//package club.fromfactory.widget;
//
...
//    }
//
//    public BadgeTextView(Context context, View target) {
//        this(context, null, 16842884, target, 0);
//    }
//
//    public BadgeTextView(Context context, TabWidget target, int index) {
...
//    }
//
//    public BadgeTextView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
...
//        this.badgeMarginH = this.dipToPixels(3);
...
//
//        return getResources().getDrawable(R.drawable.circle_red);
//
//
...
//
//
//    public void setCircleText(int num) {
//        if (num > 0) {
//            if (num > 99) {
//                this.setText("99+");
//                this.setTextSize(9);
