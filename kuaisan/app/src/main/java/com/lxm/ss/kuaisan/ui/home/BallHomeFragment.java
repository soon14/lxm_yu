...
import com.lxm.ss.kuaisan.ui.nabball.NbaBallActivity;
...
public class BallHomeFragment extends BaseFragment {
...
//    private String mCurrentUrl = "http://m.jc258.cn/data/recommendlist";  //
    ...
    String javascript = "javascript:function hideOther() {"
            + "if(null!= document.getElementById('header')) {document.getElementById('header')[0].style.display = 'none';}" +
            "}";
//    String javascript = "javascript:function hideOther() {"
...
//            "}";
    ...
    private FFWebViewClient webViewClient = new FFWebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("appinfo/ranklist")) {
                NbaBallActivity.launchActivity(getActivity());
            }else {
