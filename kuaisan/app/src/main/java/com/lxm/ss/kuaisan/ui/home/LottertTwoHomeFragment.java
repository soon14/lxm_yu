...
public class LottertTwoHomeFragment extends BaseFragment {
...
//            "}";
    private String mCurrentUrl = "https://m.139cai.com/kj/index.html#shuzi";
...
//            "}";
    String javascript = "javascript:function hideOther() {"
            + "if(null!= document.getElementsByClassName('head-hd')) {document.getElementsByClassName('head-hd')[0].style.display = 'none';}" +
            "}";
    String javascript1 = "javascript:function hideOther() {"
            + "if(null!= document.getElementsByClassName('head-nav')) {document.getElementsByClassName('head-nav')[0].style.display = 'none';}" +
            "}";
    @Override
