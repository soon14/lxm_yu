...
public class RefreshRecyclerView extends FrameLayout {
    ...
    private RecyclerAction mRefreshAction ;
    ...
    public RefreshRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.view_refresh_recycler_recycler_view);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.view_refresh_recycler_refresh_layout);
