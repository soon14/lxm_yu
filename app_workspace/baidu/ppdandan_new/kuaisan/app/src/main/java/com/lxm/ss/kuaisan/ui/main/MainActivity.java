...
import com.lottery.ui.activity.MineActivity;
...
import com.lxm.ss.kuaisan.ui.home.HomeFragmentFour;
...
//    private HomeFragmentTwo mHomeFragmentTwo ;
    private HomeFragmentFour mHomeFragmentFour ;
...
//        mHomeFragmentTwo = new HomeFragmentTwo();
        mHomeFragmentFour = new HomeFragmentFour();
        ...
        transaction.add(R.id.main_container, mHomeFragmentFour);
    ...
    private void changeTab(int tab) {
        ...
        switch (tab) {
            case ClubMenuLinearLayout.MENU_TYPE_ONE:
                ...
                showFragment(transaction,mHomeFragmentFour,null);
                break;
            case ClubMenuLinearLayout.MENU_TYPE_FOUR:
                hideFragment(transaction,mHomeFragmentFour);
                hideFragment(transaction,mCommentProblemsFragment);
