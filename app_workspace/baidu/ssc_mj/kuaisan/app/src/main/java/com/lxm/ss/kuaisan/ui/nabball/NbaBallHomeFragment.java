...
public class NbaBallHomeFragment extends BaseFragment {
...
//            "}";
    private String mTitle = "NBA排行榜" ;
    private String mCurrentUrl = "http://m.jc258.cn/appinfo/ranklist";
...
//            "}";
    ...
    String javascript1 = "javascript:function hideOther() {"
            + "if(null!= document.getElementsByClassName('footmenu_nba menu_nba')) {document.getElementsByClassName('footmenu_nba menu_nba')[0].style.display = 'none';}" +
            "}";
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View vv = inflater.inflate(R.layout.fragment_home_nbaball, container, false);
        initView(vv);
        return vv;
    }
    ...
    private void initView(View vv) {
        ...
        vv.findViewById(R.id.frament_home_nbaball_txt_tab01).setOnClickListener(mOnClickListener);
        vv.findViewById(R.id.frament_home_nbaball_txt_tab02).setOnClickListener(mOnClickListener);
        vv.findViewById(R.id.frament_home_nbaball_txt_tab03).setOnClickListener(mOnClickListener);
    ...
    private void initData() {
        ...
        mCtlTitle.setLeftTextVisible(true);
    ...
    private View.OnClickListener mOnClickListener= new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.frament_home_nbaball_txt_tab01:
                    textView = (TextView) v;
                    mCurrentUrl = "http://m.jc258.cn/appinfo/ranklist" ;
                    mCtlTitle.setTitleCenter(textView.getText().toString());
                    refreshWebview();
                    break;
                case R.id.frament_home_nbaball_txt_tab02:
                    textView = (TextView) v;
                    mCurrentUrl = "http://m.jc258.cn/appinfo/player" ;
                    mCtlTitle.setTitleCenter(textView.getText().toString());
                    refreshWebview();
                    break;
                case R.id.frament_home_nbaball_txt_tab03:
                    textView = (TextView) v;
                    mCurrentUrl = "http://m.jc258.cn/appinfo/matchresult" ;
                    mCtlTitle.setTitleCenter(textView.getText().toString());
                    refreshWebview();
                    break;
                default:
...
//            view.loadUrl(NetUtils.NETWORK_ERROR_PAGE_URL);
    ...
    private NbaBallListener mListener ;
    public void setListener(NbaBallListener listener) {
        mListener = listener;
    }

    public interface NbaBallListener {
